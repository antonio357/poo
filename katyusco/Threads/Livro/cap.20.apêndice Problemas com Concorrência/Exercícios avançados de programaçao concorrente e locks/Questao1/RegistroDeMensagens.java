...
public class RegistroDeMensagens {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread t1 = new Thread(new ProduzMensagens(0, 10000, mensagens, "Produtor de Mensagem 1"));
        Thread t2 = new Thread(new ProduzMensagens(10000, 20000, mensagens, "Produtor de Mensagem 2"));
        Thread t3 = new Thread(new ProduzMensagens(20000, 30000, mensagens, "Produtor de Mensagem 3"));
        t1.start();
        t2.start();
        t3.start();
